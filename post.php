...
$extraccion_post = "SELECT * from post";
        ...
        <div class="page-wrapper">
            ...
            <div class="topbar">            
                ...
                <nav class="navbar-custom">    
                    ...
                    <ul class="list-unstyled topbar-nav mb-0">                        
                        ...
                        <li class="creat-btn">
                            <div class="nav-link">
                                <a class=" btn btn-sm btn-soft-primary" href="new-post.php" role="button"><i class="fas fa-plus mr-2"></i>Nuevo Post</a>
                            </div>                                
                        </li>                           
                    </ul>
                </nav>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php while($perdomo =$resultado_post -> fetch_assoc()){ ?>
                    <div class="container">
                        <div class="card">
                            <div class="card-header">
                              <?php echo $perdomo['titulo']; ?>
                            </div>
                            <div class="card-body">
                              <h5 class="card-title"><?php echo $perdomo['titulo']; ?></h5>
                              <p class="card-text"><?php echo $perdomo['contenido']; ?></p>
                              <a href="edit-post.php?id=<?php echo $perdomo['id']; ?>" class="btn btn-primary" id="btn-editar">Editar</a>
                            </div>
                          </div>
                    </div>
                    <?php } ?>
