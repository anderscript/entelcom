...
$extraccion_post = "SELECT * from post where id = '$id'";

$resultado_post = $conn -> query($extraccion_post);

$perdomo = $resultado_post ->fetch_assoc();  
            ...
            <div class="topbar">            
                ...
                <nav class="navbar-custom">    
                    ...
                    <ul class="list-unstyled topbar-nav mb-0">                        
                        ...
                        <li class="creat-btn">
                            <div class="nav-link">
                                <a class=" btn btn-sm btn-soft-primary" href="#" role="button"><i class="fas fa-plus mr-2"></i>Nuevo Post</a>
                            </div>                                
                        </li>                           
                    </ul>
                </nav>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="titulo" aria-describedby="emailHelp" value="<?php echo $perdomo['titulo']; ?>">
                     <input type="hidden" class="form-control" id="id" aria-describedby="emailHelp" value="<?php echo $perdomo['id']; ?>">
                    <small id="emailHelp" class="form-text text-muted">Este es el nombre de tu post en la pagina.</small>
                    <br/>
                    <label for="exampleFormControlTextarea1">Contenido</label>
                       <textarea  class="form-control" id="contenido" rows="3"><?php echo $perdomo['contenido']; ?></textarea>
                       <small id="emailHelp" class="form-text text-muted">Este es el contenido de tu post en la pagina.</small>
                    </div>
                    <button type="button" id="btn-editar" class="btn btn-info">Publicar</button>
                    </div>
                    <br>
                    <div id="alert">
